...
## Project Structure
    ...
    ├── fragrant_waterfall_44573  # Django project configurations
...
1. Clone this repo and `cd fragrant_waterfall_44573`
...
2. Clone this repo and `cd fragrant_waterfall_44573`
